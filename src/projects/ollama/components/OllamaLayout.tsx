...
interface OllamaLayoutProps {
  images: {
    ...
    conclusionImageA: OllamaImage;
    conclusionImageB: OllamaImage;
    conclusionImageAMobile: OllamaImage;
    conclusionImageBMobile: OllamaImage;
  };
}
...
export const OllamaLayout: React.FC<OllamaLayoutProps> = ({ images }) => {
  return (
    <div className={styles['ollama-container']}>
      ...
      {/* Section 07b — Community & Values (dark grid) */}
      <section className={styles['ollama-community-dark-section']}>
      ...
      {/* Section 08 — Conclusion */}
      <section className={styles['ollama-conclusion-section']}>
        <div className={styles['ollama-conclusion-content']}>
          <div className={styles['ollama-conclusion-header']}>
            <h2 className={styles['ollama-conclusion-title']}>Conclusion</h2>
            <p className={styles['ollama-conclusion-body']}>
              The work got noticed. Ollama&apos;s team reached out.
              <br />
              Got an invitation to their community gathering and a promise of merch.
              <br />
              <br />
              Not bad for a love letter.
            </p>
          </div>
          <div className={styles['ollama-conclusion-tweet']}>
            <div className={styles['ollama-conclusion-tweet-header']}>
              <span className={styles['ollama-conclusion-tweet-pill']}>Twitter</span>
              <div className={styles['ollama-conclusion-tweet-logo']}>
            ...
            <div className={styles['ollama-conclusion-tweet-images']}>
              <img
                src={images.conclusionImageA.src}
                alt={images.conclusionImageA.alt}
                className={`${styles['ollama-conclusion-tweet-img']} ${styles['ollama-conclusion-img-desktop']}`}
              />
              <img
                src={images.conclusionImageB.src}
                alt={images.conclusionImageB.alt}
                className={`${styles['ollama-conclusion-tweet-img']} ${styles['ollama-conclusion-img-desktop']}`}
              />
              <img
                src={images.conclusionImageAMobile.src}
                alt={images.conclusionImageAMobile.alt}
                className={`${styles['ollama-conclusion-tweet-img']} ${styles['ollama-conclusion-img-mobile']}`}
              />
              <img
                src={images.conclusionImageBMobile.src}
                alt={images.conclusionImageBMobile.alt}
                className={`${styles['ollama-conclusion-tweet-img']} ${styles['ollama-conclusion-img-mobile']}`}
              />
            </div>
          </div>
