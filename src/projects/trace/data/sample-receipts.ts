...
export const SAMPLE_RECEIPTS: SampleReceipt[] = [
  {
    ...
    alt: 'Heavily crumpled Tesco receipt',
    caption: 'Heavily crumpled receipt — folds compress line items.',
    mimeType: 'image/png',
  },
  {
    id: 'tesco-2',
    ...
    alt: 'Lightly creased Tesco receipt with thermal-paper fade',
    caption: 'Standard receipt with thermal-paper fade — the everyday case.',
    mimeType: 'image/png',
  },
  {
    id: 'tesco-3',
    ...
    alt: 'Short Tesco receipt for a three-item shop',
    caption: 'Quick three-item visit — short receipts can trip up parsers.',
    mimeType: 'image/png',
  },
  {
    id: 'sainsburys',
    ...
    alt: "Sainsbury's receipt with a different store layout",
    caption: 'Different supermarket, different layout — tests format generalisation.',
    mimeType: 'image/png',
  },
];
