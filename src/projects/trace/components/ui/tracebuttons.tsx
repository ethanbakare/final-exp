  ...
  return (
    <>
      <div className="button-container">
        ...
        >
          <div className="content-container">
            {/* Rotate the wrapper div, NOT the svg — Safari wobble fix */}
      ...
      <style jsx>{`
        ...
        /* Rotating wrapper div — rotation happens HERE, not on the svg */
        .spin-wrapper {
          position: absolute;
        ...
        .morphing-right-button.state-processing .spin-wrapper {
          opacity: 1;
