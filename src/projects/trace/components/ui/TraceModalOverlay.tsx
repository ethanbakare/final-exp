...
// TraceModalOverlay Component
// Reusable modal overlay with dark background, backdrop blur, and scale animation
// Adapted from ClipModalOverlay for Trace design system

/* ============================================
   INTERFACES
   ============================================ */

interface TraceModalOverlayProps {
  isVisible: boolean;
  onClose?: () => void;
...
/* ============================================
   TRACE MODAL OVERLAY COMPONENT
   ============================================ */

export const TraceModalOverlay: React.FC<TraceModalOverlayProps> = ({
  isVisible,
  onClose,
  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .modal-overlay {
          /* Positioning - covers entire viewport */
          position: fixed;
          top: 0;
          left: 0;
          right: 0;
          ...
          /* Dark semi-transparent background - Trace colors */
          background: rgba(28, 25, 23, 0.85); /* --trace-bg-dark @ 85% */
        ...
        @supports not (backdrop-filter: blur(3px)) {
          .modal-overlay {
            background: rgba(28, 25, 23, 0.95); /* Darker without blur */
          }
        }
...
export default TraceModalOverlay;
