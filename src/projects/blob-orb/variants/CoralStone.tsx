/**
 * FINAL VARIANT: CoralStone (textured/bumpy)
 *
 * 24 high-frequency waves with per-bump normal recalculation. Fragment
 * shader brightens peaks toward white and shifts valleys toward pink
 * (hue shift). Contrast comes from colour temperature, not brightness,
 * keeping the peach/pink palette intact without any brown.
 */
...
const CoralStone: React.FC<Props> = ({ audioData, config }) => {
