/**
 * ARCHIVED — Undamped bumpy torus. Superseded by CoralStoneTorusDamped which
 * adds inner-face dampening for a cleaner hole edge.
 *
 * EXPERIMENT: CoralStoneTorus
 *
 * Torus (doughnut) version of CoralStone. Same 24 high-frequency waves
 * with per-bump normal recalculation and highlight + hue shift shader,
 * but on a torus geometry instead of a sphere. The bumpy coral texture
 * wraps around the doughnut shape.
 */
...
${dirGlsl}
  ...
  void main() {
    ...
    // Build tangent frame on the surface
...
const CoralStoneTorus: React.FC<Props> = ({ audioData, config }) => {
...
export default CoralStoneTorus;
