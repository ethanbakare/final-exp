/**
 * Material variant: Liquid Metal (v3 — CSM + MeshPhysicalMaterial)
 *
 * Uses three-custom-shader-material to inject our 24-wave vertex
 * displacement into Three.js's built-in PBR material. The PBR pipeline
 * handles metalness, roughness, and environment reflection automatically.
 *
 * Requires an <Environment> component in the parent scene to provide
 * the HDRI cubemap for reflections.
 */
...
${dirGlsl}
  ...
  void main() {
    ...
    // Recalculate normal via finite differences (same as CoralStone)
...
const CoralStoneMetal: React.FC<Props> = ({ audioData, config }) => {
...
export default CoralStoneMetal;
