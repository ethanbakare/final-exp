/**
 * FINAL VARIANT: GentleOrbTorus
 *
 * Torus (doughnut) version of GentleOrb. Same 8 sine waves with 50%
 * audio reaction, but on a torus geometry instead of a sphere. Waves
 * create ripples that travel around and along the tube.
 */
...
const GentleOrbTorus: React.FC<Props> = ({ audioData, config }) => {
