...
const GentleOrbTorusDamped = dynamic(
  () => import("../variants/GentleOrbTorusDamped"),
  { ssr: false }
);
...
const GentleOrbInfinity = dynamic(
  () => import("../variants/archived/GentleOrbInfinity"),
  { ssr: false }
);
const GentleOrbDampedBall = dynamic(
  () => import("../variants/archived/GentleOrbDampedBall"),
  { ssr: false }
);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 pb-32 select-none">
      ...
      <p className="text-center text-xs text-gray-400 mb-6">
        Circle vs Damped vs Infinity vs Ball
      </p>

      {/* Top: original torus pair */}
      <div className="max-w-3xl mx-auto grid grid-cols-2 gap-6">
        ...
        <MiniScene label="GentleOrb Damped">
          <GentleOrbTorusDamped audioData={audioData} config={config} />
        </MiniScene>
        <MiniScene label="CoralStone Damped">
      ...
      {/* Infinity + Ball variants */}
      <div className="max-w-3xl mx-auto grid grid-cols-2 gap-6 mt-6">
        <MiniScene label="GentleOrb Infinity">
          <GentleOrbInfinity audioData={audioData} config={config} />
        </MiniScene>
        <MiniScene label="GentleOrb Damped Ball">
          <GentleOrbDampedBall audioData={audioData} config={config} />
        </MiniScene>
      </div>
